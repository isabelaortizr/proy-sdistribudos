 ...
 */
public class Comando11 extends Comando {
    private final String idBloque;
    private final String refAnterior;
    private final long timestamp;
    private final String datosBloque;

    public Comando11(String idBloque, String refAnterior, long timestamp, String datosBloque) {
    ...
    public static Comando11 parsear(String comando) {
